...
- [Markdown](https://simonzeng.com//Zeng_Simon_Resume.md) (you are here!)
- [Pretty pdf](https://simonzeng.com//Zeng_Simon_Resume.pdf)

Or consumable in the following machine-readable formats:

- [Json](https://simonzeng.com//Zeng_Simon_Resume.json)
- [Yaml](https://simonzeng.com//Zeng_Simon_Resume.yaml)
- [Dhall](https://simonzeng.com//Zeng_Simon_Resume.dhall)
